    ...
    <div className="min-h-screen bg-slate-50 p-4 pb-32 flex flex-col items-center">
      <div className="w-full max-w-md flex flex-col gap-6 pt-4">
        ...
        {isPostpartum ? (
          ...
          <Card className="bg-white border-slate-200 shadow-sm rounded-3xl overflow-hidden border">
        ...
        <div className="grid grid-cols-2 gap-4">
          <a title="Call Midwife" href={familyData?.midwifePhone ? `tel:${familyData.midwifePhone}` : "#"} className="block group">
            <Card className="bg-white border-slate-200 shadow-sm rounded-3xl cursor-pointer group-hover:border-indigo-200 transition-all hover:shadow-md h-full">
          ...
          <Card className="bg-white border-slate-200 shadow-sm rounded-3xl overflow-hidden">
            <CardContent className="p-0 flex flex-col">
               <div className="p-4 border-b border-slate-100 flex items-center gap-4 hover:bg-slate-50 transition-colors">
                 <div className="w-10 h-10 rounded-2xl bg-indigo-50 flex flex-col items-center justify-center text-indigo-600 shadow-inner">
               ...
               <div className="p-4 flex items-center gap-4 hover:bg-slate-50 transition-colors">
                 <div className="w-10 h-10 rounded-2xl bg-slate-100 flex flex-col items-center justify-center text-slate-600 shadow-inner">
                   <Calendar size={18} strokeWidth={2.5} />
                 </div>
                 <div className="flex-1">
